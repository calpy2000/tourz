...
export const api = {
  ...
  getTeamPlayers: () => get(`${BASE}/team/players`),
  changeCaptain: (newCaptainId) => post(`${BASE}/team/captain`, { newCaptainId }),
  sendProblemReport: (message) => post(`${BASE}/problem-report`, { message }),
